module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            grid: {
                files: {
                    'dist/modular/js/grid.code.js': ['src/grid/js/grid.base.config.js', 'src/grid/js/grid.base.events.js', 'src/grid/js/grid.base.methods.js', 'src/grid/js/grid.base.widget.js',
                        ...
                        'src/grid/js/grid.toolbar.js', 'src/grid/js/grid.resizableColumns.js', 'src/grid/js/grid.rowReorder.js', 'src/grid/js/grid.export.js',
                    ...
                    'dist/modular/css/grid.code.css': ['src/grid/css/grid.base.css', 'src/grid/css/grid.pagination.css',
            ...
            final: {
                files: {
                    'dist/modular/js/core.js': ['src/header.txt', 'src/core/js/core.js', 'src/picker/js/picker.base.js', 'src/core/js/messages/messages.bg-bg.js', 'src/core/js/messages/messages.fr-fr.js', 'src/core/js/messages/messages.de-de.js', 'src/core/js/messages/messages.pt-br.js', 'src/core/js/messages/messages.ru-ru.js', 'src/core/js/messages/messages.es-es.js', 'src/core/js/messages/messages.it-it.js', 'src/core/js/messages/messages.tr-tr.js', 'src/core/js/messages/messages.ja-jp.js', 'src/core/js/messages/messages.zh-cn.js', 'src/core/js/messages/messages.zh-tw.js', 'src/core/js/messages/messages.lv-lv.js', 'src/core/js/messages/messages.cs-cz.js', 'src/core/js/messages/messages.az-az.js', 'src/core/js/messages/messages.el-gr.js', 'src/core/js/messages/messages.hu-hu.js', 'src/core/js/messages/messages.nl-nl.js', 'src/core/js/messages/messages.ro-ro.js'],
                    ...
                    'dist/modular/js/dialog.js': ['src/dialog/js/header.txt', 'dist/modular/js/dialog.code.js', 'src/dialog/js/messages/messages.bg-bg.js', 'src/dialog/js/messages/messages.fr-fr.js', 'src/dialog/js/messages/messages.de-de.js', 'src/dialog/js/messages/messages.pt-br.js', 'src/dialog/js/messages/messages.ru-ru.js', 'src/dialog/js/messages/messages.es-es.js', 'src/dialog/js/messages/messages.it-it.js', 'src/dialog/js/messages/messages.tr-tr.js', 'src/dialog/js/messages/messages.ja-jp.js', 'src/dialog/js/messages/messages.zh-cn.js', 'src/dialog/js/messages/messages.zh-tw.js', 'src/dialog/js/messages/messages.lv-lv.js', 'src/dialog/js/messages/messages.cs-cz.js', 'src/dialog/js/messages/messages.az-az.js', 'src/dialog/js/messages/messages.el-gr.js', 'src/dialog/js/messages/messages.hu-hu.js', 'src/dialog/js/messages/messages.nl-nl.js', 'src/dialog/js/messages/messages.ro-ro.js'],
                    'dist/modular/css/dialog.css': ['dist/modular/css/dialog.code.css'],
                    'dist/modular/js/grid.js': ['src/grid/js/header.txt', 'dist/modular/js/grid.code.js', 'src/grid/js/messages/messages.bg-bg.js', 'src/grid/js/messages/messages.fr-fr.js', 'src/grid/js/messages/messages.de-de.js', 'src/grid/js/messages/messages.pt-br.js', 'src/grid/js/messages/messages.ru-ru.js', 'src/grid/js/messages/messages.es-es.js', 'src/grid/js/messages/messages.it-it.js', 'src/grid/js/messages/messages.tr-tr.js', 'src/grid/js/messages/messages.ja-jp.js', 'src/grid/js/messages/messages.zh-cn.js', 'src/grid/js/messages/messages.zh-tw.js', 'src/grid/js/messages/messages.lv-lv.js', 'src/grid/js/messages/messages.cs-cz.js', 'src/grid/js/messages/messages.az-az.js', 'src/grid/js/messages/messages.el-gr.js', 'src/grid/js/messages/messages.hu-hu.js', 'src/grid/js/messages/messages.nl-nl.js', 'src/grid/js/messages/messages.ro-ro.js'],
                    ...
                    'dist/modular/js/editor.js': ['src/editor/js/header.txt', 'dist/modular/js/editor.code.js', 'src/editor/js/messages/messages.bg-bg.js', 'src/editor/js/messages/messages.fr-fr.js', 'src/editor/js/messages/messages.de-de.js', 'src/editor/js/messages/messages.pt-br.js', 'src/editor/js/messages/messages.ru-ru.js', 'src/editor/js/messages/messages.es-es.js', 'src/editor/js/messages/messages.it-it.js', 'src/editor/js/messages/messages.tr-tr.js', 'src/editor/js/messages/messages.ja-jp.js', 'src/editor/js/messages/messages.zh-cn.js', 'src/editor/js/messages/messages.zh-tw.js', 'src/editor/js/messages/messages.lv-lv.js', 'src/editor/js/messages/messages.cs-cz.js', 'src/editor/js/messages/messages.az-az.js', 'src/editor/js/messages/messages.el-gr.js', 'src/editor/js/messages/messages.hu-hu.js', 'src/editor/js/messages/messages.nl-nl.js', 'src/editor/js/messages/messages.ro-ro.js'],
                    ...
                    'dist/combined/js/messages/messages.lv-lv.js': ['src/dialog/js/messages/messages.lv-lv.js', 'src/grid/js/messages/messages.lv-lv.js', 'src/editor/js/messages/messages.lv-lv.js', 'src/core/js/messages/messages.lv-lv.js'],
                    'dist/combined/js/messages/messages.cs-cz.js': ['src/dialog/js/messages/messages.cs-cz.js', 'src/grid/js/messages/messages.cs-cz.js', 'src/editor/js/messages/messages.cs-cz.js', 'src/core/js/messages/messages.cs-cz.js'],
                    'dist/combined/js/messages/messages.az-az.js': ['src/dialog/js/messages/messages.az-az.js', 'src/grid/js/messages/messages.az-az.js', 'src/editor/js/messages/messages.az-az.js', 'src/core/js/messages/messages.az-az.js'],
                    'dist/combined/js/messages/messages.el-gr.js': ['src/dialog/js/messages/messages.el-gr.js', 'src/grid/js/messages/messages.el-gr.js', 'src/editor/js/messages/messages.el-gr.js', 'src/core/js/messages/messages.el-gr.js'],
                    'dist/combined/js/messages/messages.hu-hu.js': ['src/dialog/js/messages/messages.hu-hu.js', 'src/grid/js/messages/messages.hu-hu.js', 'src/editor/js/messages/messages.hu-hu.js', 'src/core/js/messages/messages.hu-hu.js'],
                    'dist/combined/js/messages/messages.nl-nl.js': ['src/dialog/js/messages/messages.nl-nl.js', 'src/grid/js/messages/messages.nl-nl.js', 'src/editor/js/messages/messages.nl-nl.js', 'src/core/js/messages/messages.nl-nl.js'],
                    'dist/combined/js/messages/messages.ro-ro.js': ['src/dialog/js/messages/messages.ro-ro.js', 'src/grid/js/messages/messages.ro-ro.js', 'src/editor/js/messages/messages.ro-ro.js', 'src/core/js/messages/messages.ro-ro.js']
                }
            }
        },
        ...
        uglify: {
            ...
            combined: {
                files: [
                    ...
                    { 'dist/combined/js/messages/messages.ro-ro.min.js': ['dist/combined/js/messages/messages.ro-ro.js'] }
                ]
            },
            modular: {
                files: {
            ...
            for (i = 0; i < names.length; i++) {
                ...
                switch (names[i].trim()) {
                    ...
                    case 'bootstrap4':
                        ...
                        break;
                    case 'bootstrap5':
                        result += '  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">\r\n';
                        break;
                    case 'fontawesome':
