module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            final: {
                files: {
                    'dist/modular/js/core.js': ['src/header.txt', 'src/core/js/core.js', 'src/picker/js/picker.base.js', 'src/core/js/messages/messages.bg-bg.js', 'src/core/js/messages/messages.fr-fr.js', 'src/core/js/messages/messages.de-de.js', 'src/core/js/messages/messages.pt-br.js', 'src/core/js/messages/messages.ru-ru.js', 'src/core/js/messages/messages.es-es.js', 'src/core/js/messages/messages.it-it.js', 'src/core/js/messages/messages.tr-tr.js', 'src/core/js/messages/messages.ja-jp.js', 'src/core/js/messages/messages.zh-cn.js', 'src/core/js/messages/messages.zh-tw.js', 'src/core/js/messages/messages.hu-hu.js'],
                    ...
                    'dist/modular/js/dialog.js': ['src/dialog/js/header.txt', 'dist/modular/js/dialog.code.js', 'src/dialog/js/messages/messages.bg-bg.js', 'src/dialog/js/messages/messages.fr-fr.js', 'src/dialog/js/messages/messages.de-de.js', 'src/dialog/js/messages/messages.pt-br.js', 'src/dialog/js/messages/messages.ru-ru.js', 'src/dialog/js/messages/messages.es-es.js', 'src/dialog/js/messages/messages.it-it.js', 'src/dialog/js/messages/messages.tr-tr.js', 'src/dialog/js/messages/messages.ja-jp.js', 'src/dialog/js/messages/messages.zh-cn.js', 'src/dialog/js/messages/messages.zh-tw.js', 'src/dialog/js/messages/messages.hu-hu.js'],
                    'dist/modular/css/dialog.css': ['dist/modular/css/dialog.code.css'],
                    'dist/modular/js/grid.js': ['src/grid/js/header.txt', 'dist/modular/js/grid.code.js', 'src/grid/js/messages/messages.bg-bg.js', 'src/grid/js/messages/messages.fr-fr.js', 'src/grid/js/messages/messages.de-de.js', 'src/grid/js/messages/messages.pt-br.js', 'src/grid/js/messages/messages.ru-ru.js', 'src/grid/js/messages/messages.es-es.js', 'src/grid/js/messages/messages.it-it.js', 'src/grid/js/messages/messages.tr-tr.js', 'src/grid/js/messages/messages.ja-jp.js', 'src/grid/js/messages/messages.zh-cn.js', 'src/grid/js/messages/messages.zh-tw.js', 'src/grid/js/messages/messages.hu-hu.js'],
                    ...
                    'dist/modular/js/editor.js': ['src/editor/js/header.txt', 'dist/modular/js/editor.code.js', 'src/editor/js/messages/messages.bg-bg.js', 'src/editor/js/messages/messages.fr-fr.js', 'src/editor/js/messages/messages.de-de.js', 'src/editor/js/messages/messages.pt-br.js', 'src/editor/js/messages/messages.ru-ru.js', 'src/editor/js/messages/messages.es-es.js', 'src/editor/js/messages/messages.it-it.js', 'src/editor/js/messages/messages.tr-tr.js', 'src/editor/js/messages/messages.ja-jp.js', 'src/editor/js/messages/messages.zh-cn.js', 'src/editor/js/messages/messages.zh-tw.js', 'src/editor/js/messages/messages.hu-hu.js'],
