        ...
        concat: {
            ...
            final: {
                files: {
                    ...
                    'dist/combined/js/messages/messages.pt-br.js': ['src/dialog/js/messages/messages.pt-br.js', 'src/grid/js/messages/messages.pt-br.js', 'src/editor/js/messages/messages.pt-br.js']
                }
            }
        },
            ...
            for (i = 0; i < names.length; i++) {
                ...
                switch (names[i].trim()) {
                    case 'bootstrap':
                        ...
                        break;
                    case 'bootstrap4':
                        result += '  <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M" crossorigin="anonymous">\r\n';
                        break;
                    case 'fontawesome':
