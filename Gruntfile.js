        ...
        concat: {
            ...
            final: {
                files: {
                    ...
                    'dist/modular/js/dialog.js': ['src/dialog/js/header.txt', 'dist/modular/js/dialog.code.js', 'src/dialog/js/messages/messages.bg-bg.js', 'src/dialog/js/messages/messages.fr-fr.js', 'src/dialog/js/messages/messages.de-de.js', 'src/dialog/js/messages/messages.pt-br.js', 'src/dialog/js/messages/messages.ru-ru.js', 'src/dialog/js/messages/messages.es-es.js'],
                    'dist/modular/css/dialog.css': ['dist/modular/css/dialog.code.css'],
                    'dist/modular/js/grid.js': ['src/grid/js/header.txt', 'dist/modular/js/grid.code.js', 'src/grid/js/messages/messages.bg-bg.js', 'src/grid/js/messages/messages.fr-fr.js', 'src/grid/js/messages/messages.de-de.js', 'src/grid/js/messages/messages.pt-br.js', 'src/grid/js/messages/messages.ru-ru.js', 'src/grid/js/messages/messages.es-es.js'],
                    ...
                    'dist/modular/js/editor.js': ['src/editor/js/header.txt', 'dist/modular/js/editor.code.js', 'src/editor/js/messages/messages.bg-bg.js', 'src/editor/js/messages/messages.fr-fr.js', 'src/editor/js/messages/messages.de-de.js', 'src/editor/js/messages/messages.pt-br.js', 'src/editor/js/messages/messages.ru-ru.js', 'src/editor/js/messages/messages.es-es.js'],
                    ...
                    'dist/modular/js/datepicker.js': ['src/datepicker/js/header.txt', 'dist/modular/js/datepicker.code.js', 'src/datepicker/js/messages/messages.bg-bg.js', 'src/datepicker/js/messages/messages.fr-fr.js', 'src/datepicker/js/messages/messages.de-de.js', 'src/datepicker/js/messages/messages.pt-br.js', 'src/datepicker/js/messages/messages.ru-ru.js', 'src/datepicker/js/messages/messages.es-es.js'],
                    'dist/modular/css/datepicker.css': ['dist/modular/css/datepicker.code.css'],
                    'dist/modular/js/timepicker.js': ['src/timepicker/js/header.txt', 'dist/modular/js/timepicker.code.js', 'src/timepicker/js/messages/messages.bg-bg.js', 'src/timepicker/js/messages/messages.fr-fr.js', 'src/timepicker/js/messages/messages.de-de.js', 'src/timepicker/js/messages/messages.pt-br.js', 'src/timepicker/js/messages/messages.ru-ru.js', 'src/timepicker/js/messages/messages.es-es.js'],
