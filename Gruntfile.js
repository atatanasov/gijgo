        ...
        concat: {
            ...
            final: {
                files: {
                    ...
                    'dist/modular/js/timepicker.js': ['src/timepicker/js/header.txt', 'dist/modular/js/timepicker.code.js', 'src/timepicker/js/messages/messages.bg-bg.js', 'src/timepicker/js/messages/messages.fr-fr.js', 'src/timepicker/js/messages/messages.de-de.js', 'src/timepicker/js/messages/messages.pt-br.js', 'src/timepicker/js/messages/messages.ru-ru.js'],
