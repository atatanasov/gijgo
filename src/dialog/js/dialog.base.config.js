...
gj.dialog.config = {
     ...
     *     });
     * </script>
     * @example False <!-- dialog.base, dialog.bootstrap, bootstrap -->
     ...
     * @default undefined
     * @example jQueryUI <!-- draggable.base, dialog.base, dialog.jqueryui, jqueryui -->
     * <div id="dialog">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <script>
     *     $("#dialog").dialog({
     *         uiLibrary: 'jqueryui'
     *     });
     * </script>
     * @example jQueryUI.Theme <!-- draggable.base, dialog.base, dialog.jqueryui, jqueryui -->
     ...
     *     });
     * </script>
     * @example Foundation <!-- draggable.base, dialog.base, dialog.foundation, foundation -->
     * <div id="dialog">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <script>
     *     $("#dialog").dialog({
