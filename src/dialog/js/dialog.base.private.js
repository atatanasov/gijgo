gj.dialog.private = {
    ...
    init: function (jsConfig) {
        ...
        gj.dialog.private.configure(this, jsConfig || {});
        ...
        gj.dialog.private.initialize(this);
        gj.dialog.events.initialized(this);
        return this;
    },

    configure: function ($dialog, jsConfig) {
        var options = $.extend(true, {}, gj.dialog.configuration.base),
            htmlConfig = gj.dialog.private.getHTMLConfiguration($dialog);
    ...
    initialize: function ($dialog) {
        ...
        gj.dialog.private.setSize($dialog);
        ...
        if ($header.length === 0) {
            ...
            gj.dialog.private.createHeader($dialog, $header);
        }
        ...
        gj.dialog.private.setPosition($dialog);
